...
//        loadDataFromDB();
    ...
    private void loadDataFromDB() {
        ...
        Product p;
        //C1: Select data using raw Query
//        Cursor cursor = db.rawQuery("SELECT * FROM " + TBL_NAME, null);
//        Cursor cursor = db.rawQuery("SELECT * FROM " + TBL_NAME + " WHERE ProductId=? OR ProductId=?",
//                                    new String[]{"2", "5"});
        // C2: Select data using query
            Cursor cursor = db.query(TBL_NAME, null, null, null, null, null, null);
//        Cursor cursor = db.query(TBL_NAME, null, "ProductId=? OR ProductId=?",
//                                    new String[]{"1", "4"}, null, null, null);
        ...
        if(item.getItemId() == R.id.mn_Delete){
            ...
            builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialogInterface, int i) {
                    int numbOfRows = db.delete(TBL_NAME, "ProductId=?", new String[]{String.valueOf(selectedProduct.getProductId())});
                    if(numbOfRows > 0){
